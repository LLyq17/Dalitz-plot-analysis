...
void drawFitPlotsProjection(TH1F m13_dat_hist, TH1F m13_pdf_hist, TH1F** m13_pdf_hist_res , int nRes, char pairname[10],std::string plotdir = "./plots_from_mixfit/"){
...
//    TH1* m23_pdf_hist_res[nRes];
   TH1F* m12_pdf_hist_res[nRes]={new TH1F("m12_pdf_hist_res[1]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit()),new TH1F("m12_pdf_hist_res[2]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit()),new TH1F("m12_pdf_hist_res[3]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit()),new TH1F("m12_pdf_hist_res[4]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit())};
    TH1F* m13_pdf_hist_res[nRes]={new TH1F("m13_pdf_hist_res[1]", "", m13.getNumBins(), m13.getLowerLimit(), m13.getUpperLimit()),new TH1F("m13_pdf_hist_res[2]", "", m13.getNumBins(), m13.getLowerLimit(), m13.getUpperLimit()),new TH1F("m13_pdf_hist_res[3]", "", m13.getNumBins(), m13.getLowerLimit(), m13.getUpperLimit()),new TH1F("m13_pdf_hist_res[4]", "", m13.getNumBins(), m13.getLowerLimit(), m13.getUpperLimit())};
    TH1F* m23_pdf_hist_res[nRes]={new TH1F("m23_pdf_hist_res[1]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit()),new TH1F("m23_pdf_hist_res[2]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit()),new TH1F("m23_pdf_hist_res[3]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit()),new TH1F("m23_pdf_hist_res[4]", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit())};
...
*/  
    ...
    TH1F* m12_pdf_res_1=new TH1F("m12_pdf_res_1", "", m12.getNumBins(), m12.getLowerLimit(), m12.getUpperLimit());   
    for (unsigned int i = 0; i < pdfValue[0].size(); ++i) {
       double currm12 = currData.getValue(m12, i);
       double currm13 = currData.getValue(m13, i);
       double currm23 = cpuGetM23(currm12, currm13);
       m12_pdf_res->Fill(currm12, pdfValue[0][i]);
       m12_pdf_res_1->Fill(currm12, pdfValue[1][i]);
    ...
    m12_dat_hist.Rebin(8.75);
    m12_pdf_hist.Rebin(8.75);
    m12_pdf_res->Rebin(8.75);
    m12_pdf_res_1->Rebin(8.75);
//    m13_dat_hist.Draw("ep");
    m12_pdf_res->Scale(m12_dat_hist.Integral()/m12_pdf_hist.Integral());
   m12_pdf_res_1->Scale(m12_dat_hist.Integral()/m12_pdf_hist.Integral());
    m12_pdf_hist.Scale(m12_dat_hist.Integral()/m12_pdf_hist.Integral());
    for (int i=0;i<m12_pdf_hist.GetNbinsX();i++)
          m12_pdf_hist.SetBinError(i+1,0);
    ...
    for (int j=0;j<m12_pdf_res->GetNbinsX();j++)
            m12_pdf_res_1->SetBinError(j+1,0);


    m12_pdf_hist.Draw("c");
    m12_dat_hist.Draw("e1same");
    m12_pdf_res->SetLineColor(kRed);
    m12_pdf_res->Draw("csame");
    m12_pdf_res_1->Draw("csame");
    foo->SaveAs((plotdir + "/m12_fit.png").c_str());
