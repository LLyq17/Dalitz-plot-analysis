...
Amp3Body *makeSignalPdf(Observable m12, Observable m13, EventNumber eventNumber, GooPdf *eff = 0) {
    ...
    ResonancePdf *rho0 = new Resonances::RBW(
        "rho0",
        fixAmps ? Variable("rho0_amp_real", 0.19) : Variable("rho0_amp_real", 0.19, 0.001, 0, 0),
        fixAmps ? Variable("rho0_amp_imag", -1.1) : Variable("rho0_amp_imag", -1.1, 0.1, 0, 0),
        fixedRhoMass,
        fixedRhoWidth,
        1,
        PAIR_12, 1);
    ...
    ResonancePdf *rho0_1450 = new Resonances::RBW(
        "rho0_1450",
        fixAmps ? Variable("rho0_1450_amp_real", 1.2) : Variable("rho0_1450_amp_real", 1.2, 0.001, 0, 0),
        fixAmps ? Variable("rho0_1450_amp_imag", -4.1) : Variable("rho0_1450_amp_imag", -4.1, 0.1, 0, 0),
        sharedMass,
        shareWidth,
        1,
        PAIR_12, 1);
...
//    dalitzplot->Draw("colz");
//    foo.cd(2);
    dalitzplot->ProjectionY()->Draw("same");
   
 //   dalitzplot->ProjectionY()->Draw("colz");
...
int main(int argc, char **argv) {
    ...
    std::string filename = "FastMC_DsPiPiPi_PWA_11K_30pt_0.root";
